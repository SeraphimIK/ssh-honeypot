...
This never executes real commands. Every shell response is a hardcoded string, and nothing typed by a connecting client is ever run on the host. It's designed to listen locally only, and it was not deployed to the public internet for this exercise.
