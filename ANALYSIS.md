...
Three separate sessions connected to the honeypot and were logged in full — every credential attempt and every command they ran.
...
- Tried `admin` / `admin123` — another common default-credential pair.
